                                        ...
                                        <TableBody>
                                            {sortedData.map((row) => (
                                                <TableRow
                                                    ...
                                                    className={`${typeof rowOnClick === 'function' ? 'cursor-pointer hover:bg-gray-100' : '' } ${row.notShow && row.notShow.urgencia ?  row.notShow.urgencia ==="Urgente" ? "border-l-4 border-red-500" : row.notShow.urgencia ==="Medio" ? "border-l-4 border-yellow-500" : "" : ""  }`}
                                                    key={row.id || row.dni}
